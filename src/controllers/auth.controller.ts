...
export class AuthController {
  static authProfile = async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  static authRegister = async (req: Request, res: Response): Promise<void> => {
  ...
  static adminGetUsers = async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  static getUserInfo = async (req: Request, res: Response): Promise<void> => {
    const userIdParam = req.params.id;
    if (!userIdParam) {
  ...
  static setup2FA = async (req: Request, res: Response): Promise<void> => {
    try {
      const userId = req.user?.id_usuario;
      if (!userId) {
        res.status(401).json({ message: "No autorizado" });
  ...
  static verify2FA = async (req: Request, res: Response): Promise<void> => {
